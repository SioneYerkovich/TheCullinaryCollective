...
urlpatterns = [
    ...
    path('favorite/breakfast/<recipe_id>/', views.add_favourite_breakfast, name='add-favourite-breakfast'),
    path('favorite/lunch/<recipe_id>/', views.add_favourite_lunch, name='add-favourite-lunch'),
    path('favorite/dinner/<recipe_id>/', views.add_favourite_dinner, name='add-favourite-dinner'),
    path('favorite/dessert/<recipe_id>/', views.add_favourite_dessert, name='add-favourite-dessert'),
    path('favorite/drinks/<recipe_id>/', views.add_favourite_drinks, name='add-favourite-drinks'),
    path('favorite/vegetarian/<recipe_id>/', views.add_favourite_vegetarian, name='add-favourite-vegetarian'),
    path('favorite/keto/<recipe_id>/', views.add_favourite_keto, name='add-favourite-keto'),
    path('favorite/MD/<recipe_id>/', views.add_favourite_md, name='add-favourite-md'),
    path('favorite/NY/<recipe_id>/', views.add_favourite_ny, name='add-favourite-ny'),
